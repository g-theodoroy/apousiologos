...
class ApousiesForDayExport implements FromView, ShouldAutoSize, WithEvents
{
  ...
  {
    if($this->apoDate)$apoDate = Carbon::createFromFormat("!d/m/y", $this->apoDate)->format("Ymd");
    if($this->eosDate)$eosDate = Carbon::createFromFormat("!d/m/y", $this->eosDate)->format("Ymd");
