                          ...
                          <table class="table yajra-datatable is-fullwidth is-hoverable" >
                            <thead>
                              <tr>
                                ...
                                <th class='has-text-centered' style="background-color: #f2f2f2;" >Τμήματα</th>
          ...
          <div class="modal-card">
            ...
            <section class="modal-card-body">
              ...
              <div class="field">
                ...
                <div class="control">
                  <input id="name" name="name" type="text" placeholder="Ονοματεπώνυμο" class="input" required >
              ...
              <!-- Text input-->
              <div class="field">
                <label class="label" for="tmimata">Τμήματα (ένα σε κάθε γραμμή)</label>
                <div class="control">
